...
%prep
%setup -q -n six-1.15.0
cd %{_builddir}/six-1.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590535183
...
cp %{_builddir}/six-1.15.0/LICENSE %{buildroot}/usr/share/package-licenses/six/ac6ba16d8833b691bbbda7c8eb0c06891c78f98f
